...
public class CreateRaceXMLUI extends javax.swing.JFrame{
    ...
    private int[] attributes = new int[]{org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_MOVEMENT_ALLOVANCE,
    org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_WEAPON_SKILL,
    org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_BALLISTIC_SKILL,
    org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_STRENGTH,
    org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_TOUGHNESS,
    org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_WOUNDS,
    org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_INITIATIVE,
    org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_ATTACKS,
    org.Warhammer.Warhammer.Unit_old.CHARACTHERISTIC_LEADERSHIP};
    private final String TITLE = "Warhammer Race XML editor";

    private org.Warhammer.Warhammer.Race race;
    public CreateRaceXMLUI(){
        ...
        setTitle(TITLE);
        race = new org.Warhammer.Warhammer.Race();
    }
    ...
    private void initComponents(){
        ...
        unitTable.setDefaultRenderer(Object.class, new org.Warhammer.UI.Resources.WarhammerRaceTableCellRenderer());
    ...
    private void openMenuItemActionPerformed(java.awt.event.ActionEvent evt){
        javax.swing.JFileChooser jfc = new javax.swing.JFileChooser(
                org.Warhammer.File.Resources.XML.DEFAULT_XML_LOCATION);
        jfc.setFileFilter(new org.Warhammer.UI.Resources.WarhammerXMLFileFilter());
        int retVal = jfc.showOpenDialog(this);
        if(retVal==javax.swing.JFileChooser.APPROVE_OPTION){
            org.Warhammer.File.XMLRaceParser xmlRP = new org.Warhammer.File.XMLRaceParser();
    ...
    private void saveMenuItemActionPerformed(java.awt.event.ActionEvent evt){
        ...
        if(race!=null){
            org.Warhammer.File.XMLRaceWriter xmlRaceWriter = new org.Warhammer.File.XMLRaceWriter();
    ...
    private void setupTableCellRendererAndEditor()
    {
        ...
        includeColumn.setCellEditor(new javax.swing.DefaultCellEditor(new javax.swing.JComboBox(org.Warhammer.UI.Resources.WarhammerRaceTableCellRenderer.TYPES)));
        includeColumn.setCellRenderer(new javax.swing.table.TableCellRenderer(){
            public java.awt.Component getTableCellRendererComponent(javax.swing.JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                javax.swing.JComboBox renderedComponent = new javax.swing.JComboBox(org.Warhammer.UI.Resources.WarhammerRaceTableCellRenderer.TYPES);
    ...
    private void populateTable(){
        if(race!=null){
            ...
            javax.swing.table.DefaultTableModel tableModel =
                (javax.swing.table.DefaultTableModel) unitTable.getModel();
            java.util.ArrayList<org.Warhammer.Warhammer.ArmyUnit> units = race.getUnits();
            for(org.Warhammer.Warhammer.ArmyUnit unit : units){
                tableModel.addRow(unit.getTableObject());
                if(unit.getUtilityUnits()!=null)
                    for(org.Warhammer.Warhammer.UtilityUnit_old crew : unit.getUtilityUnits()){
    ...
    private org.Warhammer.Warhammer.Race createRaceFromTable(){
        race = new org.Warhammer.Warhammer.Race();
        ...
        org.Warhammer.Warhammer.ArmyUnit unit = null;
        for(int i = 0 ; i < rows ; i++){
            String unitName = (String) tableModel.getValueAt(i, 0);
            if(unitName.startsWith("-")){
                org.Warhammer.Warhammer.UtilityUnit_old utilUnit = new org.Warhammer.Warhammer.UtilityUnit_old();
                utilUnit.setName(unitName);
                createUtilityUnit(utilUnit, tableModel, i);
                unit.addCrew(utilUnit);
            }
            else{
                unit = new org.Warhammer.Warhammer.ArmyUnit();
    ...
    private void createUnit(org.Warhammer.Warhammer.ArmyUnit unit,
            javax.swing.table.DefaultTableModel tableModel,
            int row){
    ...
    private void createUtilityUnit(org.Warhammer.Warhammer.UtilityUnit_old unit,
            javax.swing.table.DefaultTableModel tableModel,
            int row){
        unit.setName((String) tableModel.getValueAt(row, 0));
        unit.setCategory((String) tableModel.getValueAt(row, 10));
