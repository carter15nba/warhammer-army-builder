...
public class DatabaseManager {
    ...
    private static final String HIBERNATE_CONFIG_FILE =
            "myrmidia/Database/databaseconfig.xml";
    private static final String HIBERNATE_INIT_FILE =
            "myrmidia/Database/hibernate.cfg.xml";
        ...
        try {
            if(connection!=null)
                if(!connection.isClosed())
                    return;
            myrmidia.File.RedusedHibernateParser parser =
                    new myrmidia.File.RedusedHibernateParser();
